...
export const formio = {backgroundColor:'rgba(0,0,0,0.75)',WebkitTextFillColor:'#fff',color:'#fff',padding:"0px 10px",width:window.innerWidth<=450?"300px":"100%",boxShadow:'0 0 10px rgba(0,0,0,0)',borderRadius:'0',border:'none'}
